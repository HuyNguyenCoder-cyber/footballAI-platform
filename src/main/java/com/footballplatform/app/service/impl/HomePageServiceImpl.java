...
public class HomePageServiceImpl implements HomePageService {
    ...
    public HomePageServiceImpl(MatchService matchService, CompetitionService competitionService) {
        this.matchService = matchService;
        this.competitionService = competitionService;
    }

    @Override
    @Cacheable(cacheNames = CacheNames.HOME_PAGE,
            key = "T(com.footballplatform.app.config.CacheKeys).home(#competitionId, #status, #timeFilter, #keyword)",
            sync = true)
    public HomePageDataDTO getHomePageData(Long competitionId, MatchStatus status, String timeFilter, String keyword) {
        ...
        return HomePageDataDTO.builder()
                ...
                .selectedCompetitionName(findCompetitionName(competitions, competitionId))
                .selectedStatus(status)
                .selectedTimeFilter(normalizeTimeFilter(timeFilter))
                .selectedKeyword(keyword == null ? "" : keyword.trim())
                .build();
    }
